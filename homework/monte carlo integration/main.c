...
int main(int argc, char const *argv[]) {
  ...
  printf("_________________________ PARTS A) AND B) _________________________\n");
  ...
  resultTestStrat = stratMC(2, func2, lowerBoundTest, upperBoundTest, absAcc, relAcc, numOfRecalls, meanRecall);
